...
Pri pisanju diplomske naloge upoštevamo akademski slog, ki se močno razlikuje od poljudnega pisanja. Besedilo pišemo v prvi osebi množine (npr. \enquote{razvili smo}, \enquote{opazimo}), saj s tem poudarimo objektivnost raziskovalnega procesa, v katerega sta vključena študent in mentor.

Terminologija mora biti dosledna. Če se odločite za slovenski izraz, ga uporabljajte skozi celotno nalogo; mešanje slovenskih in angleških izrazov za isti pojem (npr. \textit{strojno učenje} in \textit{machine learning}) zmanjšuje berljivost. Bistvene ugotovitve je priporočljivo omeniti na več mestih, vendar v različnih ravneh podrobnosti: visokonivojsko v povzetku, motivacijsko v uvodu, tehnično v jedru in sintetično v zaključku.

Vse trditve v nalogi morajo biti preverljive. To pomeni, da morajo temeljiti na lastnih izpeljavah ali testiranjih, če pa povzemate ugotovitve drugih, je navajanje vira obvezno. Dobra praksa je, da pred začetkom pisanja preberete nekaj najbolje ocenjenih diplomskih nalog iz preteklih let, saj so to najboljši zgledi za strukturiranje lastnih misli.
...
Standard A-4 spoštuje tudi pravila iz A-1b. Če vam Studis nalaganje dokumenta vseeno zavrne nastavite prvo deklaracijo v tem dokumentu iz \texttt{pdfstandard = A-4} v \texttt{pdfstandard = A-1b}.

V predlogi so poleg izvornega  dokumenta \texttt{diploma-FRI-vzorec.tex}, še vložena slika \texttt{galaksija.jpg}, datoteka \texttt{literatura.bib} za uporabljeno literaturo  ter
...
\subsection{Definicije in pravila zapisa}
